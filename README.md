...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/admin-required%20⚠️-E67E22" alt="Admin required">
...
- 🔧 **Единственное действие** — запись в хранилище `LocalMachine\Disallowed`, которую вы отменяете кнопкой «Разблокировать».
...
Ожидаемое значение для `CertBlocker.exe` из релиза **v1.0.3**:
